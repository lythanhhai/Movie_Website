...
const Header = ({ getResultSearch, modal__browser }) => {
  ...
  const Header__account__notHover = document.getElementById(
    "Header__account-notHover"
  );
  const Header__account__Hover = document.getElementById(
    "Header__account-Hover"
  );
  const Header__account__modalUser = document.getElementsByClassName(
    "Header__account-modalUser"
  )[0];
